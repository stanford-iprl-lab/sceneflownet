...
from models.model_4d import depth_model
...
experiment_name = 'seg_std_4d_2sigma_test'
...
parser.add_argument('--train_tfrecords_filename',default=os.path.join(DATA_DIR,'Tfrecords','val.tfrecords'),help='directory to contain train tfrecord files')
parser.add_argument('--val_tfrecords_filename',default=os.path.join(DATA_DIR,'Tfrecords','val.tfrecords'),help='directory to contain train tfrecord files')
...
ex = Experiment(FLAGS,inputs,depth_model,loss,log)
ex.whole_process()
