...
from models.cc_vgg16 import cnnmodel
...
from lossf.cc_loss import loss
from inference.infer import nms,infer_seg
experiment_name = 'cc_vgg16'
...
parser.add_argument('--val_batch_size',type=int,default=4,help='Number of models within a batch.')
...
parser.add_argument('--train_tfrecords_filename',default=os.path.join(DATA_DIR,'Tfrecords_SegNet2','train.tfrecords'),help='directory to contain train tfrecord files')
parser.add_argument('--val_tfrecords_filename',default=os.path.join(DATA_DIR,'Tfrecords_SegNet2','val.tfrecords'),help='directory to contain train tfrecord files')
...
from tf_libs.cc_experiment import Experiment
